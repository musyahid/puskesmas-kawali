...
class Satuanbarang extends CI_Controller
{
    ...
    {
        $this->template->load('template','satuanbarang/tbl_satuan_barang_list');
    } 
    ...
    public function read($id) 
    {
		...
		'nama_satuan' => $row->nama_satuan,
            ...
            $this->template->load('template','satuanbarang/tbl_satuan_barang_read', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('satuanbarang'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Create',
            'action' => site_url('satuanbarang/create_action'),
	    'id_satuan_barang' => set_value('id_satuan_barang'),
	    'nama_satuan' => set_value('nama_satuan'),
	);
        $this->template->load('template','satuanbarang/tbl_satuan_barang_form', $data);
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('satuanbarang/update_action'),
    ...
    public function update_action() 
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            $this->update($this->input->post('id_satuan_barang', TRUE));
        } else {
            $data = array(
		'nama_satuan' => $this->input->post('nama_satuan',TRUE),
	    );

            $this->Tbl_satuan_barang_model->update($this->input->post('id_satuan_barang', TRUE), $data);
	...
	$this->form_validation->set_rules('id_satuan_barang', 'id_satuan_barang', 'trim');
    ...
    public function word()
    {
        ...
        $this->load->view('satuanbarang/tbl_satuan_barang_doc',$data);
    }
