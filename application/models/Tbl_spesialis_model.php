...
class Tbl_spesialis_model extends CI_Model
{
    ...
    // datatables
    function json() {
        $this->datatables->select('id_spesialis,nama_spesialis');
        $this->datatables->from('tbl_spesialis');
        //add this line for join
        //$this->datatables->join('table2', 'tbl_spesialis.field = table2.field');
        $this->datatables->add_column('action', anchor(site_url('spesialis/update/$1'),'<i class="fa fa-pencil-square-o" aria-hidden="true"></i>', array('class' => 'btn btn-danger btn-sm'))." 
	...
	$this->db->or_like('nama_spesialis', $q);
