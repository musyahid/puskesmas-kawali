...
<html>
    <head>
        ...
        <title>Brocode | CRUD Generator</title>
...
border-radius: 2px;
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <header class="main-header">
                ...
                <a href="<?php echo base_url() ?>adminlte/index2.html" class="logo">
                    ...
                    <span class="logo-lg"><b>PSKSMS</b>KWL</span>
                </a>
            ...
            <footer class="main-footer">
                ...
                <strong>Copyright &copy; 2009-2021 <a href="https://adminlte.io">Almsaeed Studio</a>.</strong> All rights
                reserved.
            </footer>
        ...
        <!-- Myscript alert -->
        <script src="<?php echo base_url('assets') ?>/sweetalert/myscriptalert.js"></script>
        <!-- page script -->
        <script>
            $(function () {
                $('.select2').select2()
                $('#datatables_riwayat_tindakan').DataTable()
