    ...
    <body>
		...
		<th>Keluhan</th>
            ...
            foreach ($inputinap_data as $inputinap)
            {
		      ...
		      <td><?php echo $inputinap->id_tempat_tidur ?></td>
		      <td><?php echo $inputinap->id_obat ?></td>
		      <td><?php echo $inputinap->id_tindakan ?></td>
		      <td><?php echo $inputinap->id_pemeriksaan_laboratorium ?></td>
		      <td><?php echo $inputinap->id_diagnosa_penyakit ?></td>
		      <td><?php echo $inputinap->Hasil_pemeriksaan_fisik ?></td>
		      <td><?php echo $inputinap->riwayat_penyakit ?></td>
		      <td><?php echo $inputinap->keluhan ?></td>	
                </tr>
                <?php
            }
            ?>
