...
<table class='table table-bordered>'        
	    ...
	    <tr><td width='200'>Nama Spesialis <?php echo form_error('nama_spesialis') ?></td><td><input type="text" class="form-control" name="nama_spesialis" id="nama_spesialis" placeholder="Nama Spesialis" value="<?php echo $nama_spesialis; ?>" /></td></tr>
