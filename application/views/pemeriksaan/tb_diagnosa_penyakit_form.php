...
<table class='table table-bordered>'  
         ...
         <tr><td width='200'>Kode Penyakit <?php echo form_error('id_diagnosa_penyakit') ?></td><td><input type="text" class="form-control" name="id_diagnosa_penyakit" id="id_diagnosa_penyakitt" placeholder="Masukkan Kode Penyakit" value="<?php echo $id_diagnosa_penyakit; ?>" /></td></tr>      
	    ...
	    <a href="<?php echo site_url('pemeriksaan') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a></td></tr>
	</table></form>        </div>
</div>
</div>