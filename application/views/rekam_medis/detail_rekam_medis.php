                        ...
                        <div class="modal-body">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr><td>Ciri - Ciri Penyakit</td><td>
                                  <input type="text" name="ciri_ciri_penyakit" id="ciri_ciri_penyakit" class="form-control" placeholder="Ciri - ciri penyakit" disabled>
                                </td></tr>
                                <tr><td>Ciri - Ciri Umum</td><td>
                                  <input type="text" name="ciri_ciri_umum" id="ciri_ciri_umum" class="form-control" placeholder="Ciri - ciri umum" disabled>
                                </td></tr>
